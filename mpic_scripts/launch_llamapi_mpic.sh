...
# Huggingface
export LLAMAPI_GLOBAL_HF_CACHE_DIRECTORY=${LLAMAPI_GLOBAL_HF_CACHE_DIRECTORY:-/fast/nrahaman/persistmp/transformers_cache}
...
echo "Global Huggingface Cache Directory: $LLAMAPI_GLOBAL_HF_CACHE_DIRECTORY"
echo "Local Huggingface Cache Directory: $LLAMAPI_LOCAL_HF_CACHE_DIRECTORY"
